                    ...
                    <Table colorScheme={'twitter'} className={'table table-responsive-sm'} size={'sm'}>
                        <Thead>
                            <Tr>
                                ...
                                <Th className={'bg-dark text-center text-white'}>MINUTOS DIA</Th>
                                ...
                                <Th className={'bg-dark text-center text-white'}>QT</Th>
                                <Th className="text-center">Fe/Gusa/(KG)</Th>
                                <Th className={'bg-dark text-center text-white'}>Fe₂O₃</Th>
                            </Tr>
                        </Thead>
                        <Tbody >
                            {corridas.map((corrida, index) => (
                                <Tr key={index}>
                                    ...
                                    <Td className={'bg-dark text-center text-white'}>{corrida.minutos}</Td>
                                    ...
                                    <Td className={'bg-dark text-center text-white'}>{corrida.quantidade}</Td>
                                    <Td className="text-center">{corrida.feGusaKg}</Td>
                                    <Td className={'bg-dark text-center text-white'}>{corrida.ferro}</Td>
                                </Tr>
                            ))}
                        </Tbody>
                    </Table>
